...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: '/js/templates/controls/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '='
    }
...
.directive('slide', [function() {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: '/js/templates/controls/carousel/slide.html',
    scope: {
      active: '='
    },
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: '/js/templates/controls/dialog/message.html', controller: 'MessageBoxController', resolve:
          {model: function() {
            return {
              title: title,
              message: message,
...
.directive('pagination', ['paginationConfig', function(paginationConfig) {
  return {
    ...
    templateUrl: '/js/templates/controls/pagination/pagination.html',
    replace: true,
    link: function(scope, element, attrs) {
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: '/js/templates/controls/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: '/js/templates/controls/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: '/js/templates/controls/popover/popover.html'
  };
})
...
.directive('progress', function() {
    return {
        ...
        templateUrl: '/js/templates/controls/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function($transition) {
    return {
        ...
        templateUrl: '/js/templates/controls/progressbar/bar.html',
...
.directive('rating', ['ratingConfig', '$parse', function(ratingConfig, $parse) {
  return {
    ...
    templateUrl: '/js/templates/controls/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs) {
...
define(
	'app/controllers/pages/project_details_controller',['angular', 'app/models/component_type'],
...
define('app/directives/components/location/map',[],function(){
	...
	return function(){
		return {
			...
			template: '<iframe style="width:100%;height:100%;" width="425" ' +
					'height="350" frameborder="0" scrolling="no" ' +
					'marginheight="0" marginwidth="0" ' +
					'src="https://maps.google.com/maps?q=37.778368,' +
					'-122.409198&amp;num=1&amp;ie=UTF8&amp;ll=37.778278,' +
					'-122.409214&amp;spn=0.016756,0.037594&amp;t=m&amp;z=14' +
					'&amp;output=embed">' +
				'</iframe>',
...
define('app/directives/controls/style_editor',['app/models/component_type'], function(ComponentType) {
